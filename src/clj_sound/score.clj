...
(defn* bz3 [x]
  [MoogLP [Dist [* {0 0.5 0x30 0.55 0x70 0.6 0x90 0}
...
(defn* out [x]
  [0x000 [* {0 1.2 0x018 0.05 0x22 0.1 0xa0 1 0x100 1}
          [verb [l]]]
   0x100])
...
(defn* out [x]
  {:bd [0x000 [bd 1]
   ...
   :<- [+ :bd
        [0x000 
         [* 0.2 {0 1.2 0x018 0.05 0x22 0.1 0xa0 1 0x100 1} [verb [l]]]
         0x100]]})
