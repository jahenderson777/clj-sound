// based on https://github.com/kmatheussen/soundengine/blob/master/FreeVerb.java

public class Reverb implements UGen{
    ...
    public float[] process(int count, float[][] inputs) {
        ...
        float[] out2 = new float[count];
        float[][] inputs2 = {inputs[0], inputs[0]};
        float[][] outputs = {out, out2};
        compute(count, inputs2, outputs);
        return out;
    }

    public Reverb(int initialX){ 
        fslider0 = 0.5f;
        fslider1 = 0.5f;
        IOTA = 0;
        fslider2 = 0.3333f;
